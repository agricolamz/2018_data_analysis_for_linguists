...
### 7. Домашнее задание
Домашнее задание нужно выполнять в отдельном `rmarkdown` файле, скачав данные [из своей папки](https://github.com/agricolamz/2018_data_analysis_for_linguists/tree/master/data/students) в репозитории курса. Получившиеся файлы следует помещать в соответствующую папку в своем репозитории на гитхабе. Более подробные инструкции [см. внизу этой страницы](file:///home/agricolamz/work/materials/2018_I_HSE_Data_Analysis_for_linguists/docs/index.html).

#### 1.1
Скачайте датасет `hw1_1_zilo_class.csv` ([см. описание выше](https://agricolamz.github.io/2018_data_analysis_for_linguists/2_agreement.html#12_%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5:_%D0%B7%D0%B8%D0%BB%D0%BE%D0%B2%D1%81%D0%BA%D0%B8%D0%B9_%D1%8D%D0%BA%D1%81%D0%BF%D0%B5%D1%80%D0%B8%D0%BC%D0%B5%D0%BD%D1%82)). Выведите тиббл содержащий два столбца: `stimulus_source` и количество уникальных слов в датасете (`n`).
...
#### 2.1
Скачайте датасет `hw1_2_.csv` ([см. описание выше]())
