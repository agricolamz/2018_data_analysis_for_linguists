...
cd /home/agricolamz/work/materials/2018_I_HSE_Data_Analysis_for_linguists/data/answers/headshoter13
tree
```
...
Календарь можно скачать [в формате `.csv`](https://raw.githubusercontent.com/agricolamz/2018_data_analysis_for_linguists/master/data_analysis_calendar.csv) и импортировать в Google Calendar.
